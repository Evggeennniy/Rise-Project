...
class SupportMail(models.Model):
    ...
    question = models.CharField(verbose_name='Опис', max_length=512)
    notes = models.CharField(verbose_name='Примітки', max_length=64)
    ...
    answer = models.CharField(verbose_name='Відповідь', max_length=128, blank=True)
